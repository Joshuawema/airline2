...
<!-- Page Content -->
<div class="page-heading about-heading header-text" style="background-image: url(https://images.unsplash.com/photo-1541707423647-46d6213e390a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=667&q=80);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <ul class="pages">
                    ...
                    <li><a href="packages2.php">2</a></li>
                    <li class="active"><a href="packages3.php">3</a></li>
                    <li><a href="packages4.php">4</a></li>
                </ul>
            </div>
        </div>
    </div>
